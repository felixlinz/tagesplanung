...
from tour_items import TourItem, TourList, EntryTourItem
...
class DayTab:
    def __init__(self, master, day, datamanager):
        ...
        self.tourlist = TourList(self.master, self.data)
    ...
    def add_tour(self, dataset):
        ...
        self.tourlist.touren.append(TourItem(self.tourlist, tour_number, wave, alt_time))
        self.tourlist.refresh()
        self.add_button.pack()
